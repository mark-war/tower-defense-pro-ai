        ...
        for (let i = engine.enemies.length - 1; i >= 0; i--) {
          ...
          if (e.burnTimer > 0) {
            ...
            if (engine.tick % 20 === 0) {
              ...
              if (e.burnSourceId) {
                const burnTower = engine.towers.find((t) => t.id === e.burnSourceId);
                if (burnTower) {
          ...
          if (e.mutation?.apply?.voidStep) {
            ...
            if (e._voidStepTimer >= e.mutation.apply.voidStepInterval) {
              ...
              if (targetIdx > e.pathIndex) {
                ...
                engine.vfx.addFloatingText(e.x, e.y - 30, "⚡ VOID STEP!", "#818cf8");
              }
            }
          }
          ...
          if (e.type === "healer" && engine.tick % healInterval === 0) {
            ...
            if (healed > 0) {
              engine.vfx.addFloatingText(e.x, e.y - 24, `⚕ HEAL ×${healed}`, "#4ade80");
            }
          }
          ...
          if (
            ...
            e.hp = Math.min(
              e.maxHp,
              e.hp + e.maxHp * engine.activeModifier.apply.enemyRegenRate,
            );
          }
          ...
          if (e.isBoss) {
            ...
            if (e.rageTimer > 0 && e.rageTimer % 1500 === 0) {
              ...
              engine.vfx.addFloatingText(e.x, e.y - 44, "🔥 BOSS ENRAGED!", "#ef4444");
            }
          }
